      ...
      <div className="container">
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto w-full max-w-lg text-center">
            ...
            <p className="md:text-md">
              Stay updated with our coding tips and tricks.
            </p>
          </div>
        </div>
        <div className="grid grid-cols-1 gap-x-8 gap-y-16 md:grid-cols-2 md:gap-y-12 lg:grid-cols-3">
          <div>
            ...
            <p>
              Unlock the secrets of JavaScript to enhance your coding skills.
            </p>
          ...
          <div>
            ...
            <p>Discover how AI can transform your coding experience.</p>
            <div className="mt-6 flex items-center">
              <div className="mr-4 shrink-0">
                <img
                  src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image.svg"
              ...
              <div>
                ...
                <div className="flex items-center">
                  <p className="text-sm">15 Feb 2023</p>
                  <span className="mx-2">•</span>
          ...
          <div>
            ...
            <p>
              Explore trends shaping the future of programming and development.
            </p>
            <div className="mt-6 flex items-center">
              <div className="mr-4 shrink-0">
                <img
              ...
              <div>
                ...
                <div className="flex items-center">
                  <p className="text-sm">20 Mar 2023</p>
                  <span className="mx-2">•</span>
