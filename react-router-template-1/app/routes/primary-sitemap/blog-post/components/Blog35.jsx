        ...
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto w-full max-w-lg text-center">
            ...
            <p className="md:text-md">
              Discover tips and tricks for coding success.
            </p>
          </div>
        </div>
        <div className="grid grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-2 md:gap-y-16 lg:grid-cols-3">
          <div className="border border-border-primary">
            ...
            <div className="px-5 py-6 md:p-6">
              ...
              <p>Learn the fundamentals of JavaScript programming easily.</p>
          ...
          <div className="border border-border-primary">
            ...
            <div className="px-5 py-6 md:p-6">
              ...
              <p>Create responsive designs with CSS Flexbox easily.</p>
              <div className="mt-6 flex items-center">
                <div className="mr-4 shrink-0">
                  <img
                    src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image.svg"
          ...
          <div className="border border-border-primary">
            ...
            <div className="px-5 py-6 md:p-6">
              ...
              <p>Learn how to create adaptable websites for all devices.</p>
              <div className="mt-6 flex items-center">
                <div className="mr-4 shrink-0">
                  <img
                    src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image.svg"
